...
Public Class Form1
    ...
    Private Sub Form1_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
        ...
        Catch ex As Exception
            MsgBox("Please Restart the Application.", MsgBoxStyle.Critical, "Critical Error")
        End Try
    End Sub
    ...
    Private Sub Button1_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles Button1.Click
        ...
        If st = 1 Then
            Try
                ...
                strsql2 = "insert into acctable values(" & in_srno & "," & invoice & "," & obj_no & ",'" & p_code & "','" & desc & "'," & qty & "," & rate & "," & vat & "," & tamt & ",'" & status & "','" & c_date & "','" & amt_type & "','" & ref_no & "'," & amt & ",'" & amt_date & "','" & credit & "')"
        ...
        Try
            ...
            If RadioButton4.Checked = True Then
                ...
                While rs1.Read()
                    ...
                    TextBox11.Text = rs1(7)
                    TextBox12.Text = rs1(8)
                    TextBox13.Text = rs1(4)
                    DateTimePicker1.Text = rs1(15)
                End While
    ...
    Private Sub Button4_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles Button4.Click
        ...
        Dim mymatch9 As Match = System.Text.RegularExpressions.Regex.Match(TextBox8.Text, "^\d+$")
    ...
    Private Sub Button9_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles Button9.Click
        ...
        ElseIf Not IsNumeric(ComboBox3.SelectedItem) Then
            ...
            GroupBox9.Enabled = False
        ElseIf Not mymatch6.Success Then
            MessageBox.Show("Please Enter the valid VAT with Decimal Precision. ", "Error")
            GroupBox9.Enabled = False
        Else
            GroupBox1.Enabled = False
    ...
    Private Sub ComboBox4_SelectedIndexChanged(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles ComboBox4.SelectedIndexChanged
        ...
        invoice = CInt(ComboBox2.SelectedItem)
        Dim obj_no As Integer
        obj_no = CInt(ComboBox4.SelectedItem)
        ...
        If RadioButton4.Checked = True Then
            ...
            cmd1 = New OleDbCommand("select * from acctable where p_code = '" & p_code & "' AND status='Balance' AND invoice = " & invoice & " AND obj_no = " & obj_no & " ", con)
            rs1 = cmd1.ExecuteReader()
        ...
        Else
            Try
                ...
                With wdDoc
                    ...
                    dr = cmd.ExecuteReader()
                    While (dr.Read) = True
                        .FormFields("text" + CStr(cnt) + "1").Range.Text = dr(2)
                        .FormFields("text" + CStr(cnt) + "2").Range.Text = dr(4)
                        .FormFields("text" + CStr(cnt) + "3").Range.Text = dr(5)
                        .FormFields("text" + CStr(cnt) + "4").Range.Text = dr(6)

                        Dim qty As Integer = CInt(dr(5))
                        Dim rate As Integer = CInt(dr(6))
                        vat = CDec(dr(7))
                        amt = rate * qty
            ...
            Catch ex As Exception
                MsgBox("Error in Creating Word Document.", MsgBoxStyle.Critical, "Failure")
            End Try
        End If
